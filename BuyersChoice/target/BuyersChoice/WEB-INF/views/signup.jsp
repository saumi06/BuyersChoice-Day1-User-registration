...
<!SEX>
	...
	<label class="control-label col-sm-2" for="sex">Sex:</label>
		<div class="col-sm-10">
		<label class="radio-inline col-sm-2"><input type="radio" path="sex" name="sex" >Male</label>
		<label class="radio-inline col-sm-2"><input type="radio" path="sex" name="sex" >Female</label>
...
<!ADDRESS>
 ...
 <!USERNAME AND PASSWORD>
	...
	<label class=" control-label col-sm-2" for="username">UserName:</label>
		<div class="col-sm-10">
			<sf:input  path="username" type="text" class="form-control" id="username" placeholder="Enter desired username(min length: 3)" 
